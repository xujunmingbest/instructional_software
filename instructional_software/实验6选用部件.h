...
namespace instructional_software {
	...
	/// 实验6选用部件 摘要
	/// </summary>
	public ref class 实验6选用部件 : public System::Windows::Forms::Form
	{
	public:
		实验6选用部件(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(实验6选用部件::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &实验6选用部件::button1_Click);
			// 
			// label2
			// 
			...
			this->Name = L"实验6选用部件";
			this->Text = L"实验6选用部件";
			this->Load += gcnew System::EventHandler(this, &实验6选用部件::实验6选用部件_Load);
...
#pragma endregion
	private: System::Void 实验6选用部件_Load(System::Object^  sender, System::EventArgs^  e) {
		init();
	}
			 ...
			 Thread ^Thread_speek;
			 void speek_control() {
				 Speek("实验6选用组件:三箱异步电动机（/380V）1件");
				 Speek("三箱异步电动机（/380V）1件");
				 Speek("继电控制接触挂箱1 一件");
			 ...
			 void Speek(String ^in) {
				 Thread_speek = gcnew Thread(gcnew ThreadStart(this, &实验6选用部件::speek));
