...
namespace instructional_software {
	...
	/// 实验5讨论题 摘要
	/// </summary>
	public ref class 实验5讨论题 : public System::Windows::Forms::Form
	{
	public:
		实验5讨论题(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"1、什么叫两地控制？两地控制有何特点？";
			...
			this->label2->Text = L"2、两地控制的接线原则是什么？";
			...
			this->button1->Click += gcnew System::EventHandler(this, &实验5讨论题::button1_Click);
			// 
			// 实验5讨论题
			// 
			...
			this->Name = L"实验5讨论题";
			this->Text = L"实验5讨论题";
			this->Load += gcnew System::EventHandler(this, &实验5讨论题::实验5讨论题_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void 实验5讨论题_Load(System::Object^  sender, System::EventArgs^  e) {
	}
			 Thread ^Thread_speek;
			 void speek_control() {
				 Speek(label2->Text);
			 ...
			 void Speek(String ^in) {
				 Thread_speek = gcnew Thread(gcnew ThreadStart(this, &实验5讨论题::speek));
