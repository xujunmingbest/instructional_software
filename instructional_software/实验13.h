...
namespace instructional_software {
	...
	/// 实验13 摘要
	/// </summary>
	public ref class 实验13 : public System::Windows::Forms::Form
	{
	public:
		实验13(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->实验目的ToolStripMenuItem->Click += gcnew System::EventHandler(this, &实验13::实验目的ToolStripMenuItem_Click);
			// 
			...
			this->选用组件ToolStripMenuItem->Click += gcnew System::EventHandler(this, &实验13::选用组件ToolStripMenuItem_Click);
			// 
			...
			this->实验方法ToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->实验方法一ToolStripMenuItem,
					this->实验方法二ToolStripMenuItem, this->实验方法三ToolStripMenuItem
			});
			...
			this->实验方法一ToolStripMenuItem->Click += gcnew System::EventHandler(this, &实验13::实验方法一ToolStripMenuItem_Click);
			// 
			...
			this->实验方法二ToolStripMenuItem->Click += gcnew System::EventHandler(this, &实验13::实验方法二ToolStripMenuItem_Click);
			// 
			...
			this->实验方法三ToolStripMenuItem->Click += gcnew System::EventHandler(this, &实验13::实验方法三ToolStripMenuItem_Click);
			// 
			...
			this->讨论题ToolStripMenuItem->Click += gcnew System::EventHandler(this, &实验13::讨论题ToolStripMenuItem_Click);
			// 
			// 实验13
			// 
			...
			this->Name = L"实验13";
			this->Text = L"实验十三、X62W铣床模拟控制线路的调试分析";
			this->Load += gcnew System::EventHandler(this, &实验13::实验13_Load);
...
#pragma endregion
	private: System::Void 实验13_Load(System::Object^  sender, System::EventArgs^  e) {
	}
			 实验13实验目的^ 实验13实验目的wnd;
			 实验13选用组件^ 实验13选用组件wnd;
			 实验13实验方法1 ^实验13实验方法1wnd;
			 实验13实验方法2 ^实验13实验方法2wnd;
			 实验13实验方法3 ^实验13实验方法3wnd;
			 实验13讨论题^ 实验13讨论题wnd;
private: System::Void 实验目的ToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	if (实验13实验目的Status == true)
	{
		实验13实验目的wnd->BringToFront(); //这个可以置于最前面
		实验13实验目的wnd->WindowState = FormWindowState::Maximized;
		return;
	}
	实验13实验目的wnd = gcnew 实验13实验目的;
	实验13实验目的wnd->MdiParent = this;
	实验13实验目的wnd->Show();
	实验13实验目的wnd->WindowState = FormWindowState::Maximized;
...
private: System::Void 选用组件ToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	if (实验13选用组件Status == true)
	{
		实验13选用组件wnd->BringToFront(); //这个可以置于最前面
		实验13选用组件wnd->WindowState = FormWindowState::Maximized;
		return;
	}
	实验13选用组件wnd = gcnew 实验13选用组件;
	实验13选用组件wnd->MdiParent = this;
	实验13选用组件wnd->Show();
	实验13选用组件wnd->WindowState = FormWindowState::Maximized;
}
private: System::Void 实验方法一ToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	if (实验13实验方法1Status == true)
	{
		实验13实验方法1wnd->BringToFront(); //这个可以置于最前面
		实验13实验方法1wnd->WindowState = FormWindowState::Maximized;
		return;
	}
	实验13实验方法1wnd = gcnew 实验13实验方法1;
	实验13实验方法1wnd->MdiParent = this;
	实验13实验方法1wnd->Show();
	实验13实验方法1wnd->WindowState = FormWindowState::Maximized;
}
private: System::Void 实验方法二ToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	if (实验13实验方法2Status == true)
	{
		实验13实验方法2wnd->BringToFront(); //这个可以置于最前面
		实验13实验方法2wnd->WindowState = FormWindowState::Maximized;
		return;
	}
	实验13实验方法2wnd = gcnew 实验13实验方法2;
	实验13实验方法2wnd->MdiParent = this;
	实验13实验方法2wnd->Show();
	实验13实验方法2wnd->WindowState = FormWindowState::Maximized;

}
private: System::Void 实验方法三ToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	if (实验13实验方法3Status == true)
	{
		实验13实验方法3wnd->BringToFront(); //这个可以置于最前面
		实验13实验方法3wnd->WindowState = FormWindowState::Maximized;
		return;
	}
	实验13实验方法3wnd = gcnew 实验13实验方法3;
	实验13实验方法3wnd->MdiParent = this;
	实验13实验方法3wnd->Show();
	实验13实验方法3wnd->WindowState = FormWindowState::Maximized;
}
private: System::Void 讨论题ToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
	if (实验13讨论题Status == true)
	{
		实验13讨论题wnd->BringToFront(); //这个可以置于最前面
		实验13讨论题wnd->WindowState = FormWindowState::Maximized;
		return;
	}
	实验13讨论题wnd = gcnew 实验13讨论题;
	实验13讨论题wnd->MdiParent = this;
	实验13讨论题wnd->Show();
	实验13讨论题wnd->WindowState = FormWindowState::Maximized;
}
};
