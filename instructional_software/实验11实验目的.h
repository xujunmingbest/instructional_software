...
namespace instructional_software {
	...
	/// 实验11实验目的 摘要
	/// </summary>
	public ref class 实验11实验目的 : public System::Windows::Forms::Form
	{
	public:
		实验11实验目的(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"2、熟悉掌握平面磨床一些独特的控制线路。";
			...
			this->label2->Text = L"l、通过对M7130平面磨床的电气控制线路的实际接线和操作，初步掌握另一种工厂机床磨床的基本工作原理。";
			...
			this->button1->Click += gcnew System::EventHandler(this, &实验11实验目的::button1_Click);
			// 
			// 实验11实验目的
			// 
			...
			this->Name = L"实验11实验目的";
			this->Text = L"实验11实验目的";
			this->Load += gcnew System::EventHandler(this, &实验11实验目的::实验11实验目的_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void 实验11实验目的_Load(System::Object^  sender, System::EventArgs^  e) {
	}
			 Thread ^Thread_speek;
			 void speek_control() {
				 Speek(label1->Text);
			 ...
			 void Speek(String ^in) {
				 Thread_speek = gcnew Thread(gcnew ThreadStart(this, &实验11实验目的::speek));
