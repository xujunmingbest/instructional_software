...
namespace instructional_software {
	...
	/// 实验10实验目的 摘要
	/// </summary>
	public ref class 实验10实验目的 : public System::Windows::Forms::Form
	{
	public:
		实验10实验目的(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"2、使学生真正从书本走向实际，接触实际的机床控制。";
			...
			this->label2->Text = L"1、通过对C620车床电气控制线路的接线，使学生真正掌握机床控制的原理。";
			...
			this->button1->Click += gcnew System::EventHandler(this, &实验10实验目的::button1_Click);
			// 
			// 实验10实验目的
			// 
			...
			this->Name = L"实验10实验目的";
			this->Text = L"实验10实验目的";
			this->Load += gcnew System::EventHandler(this, &实验10实验目的::实验10实验目的_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void 实验10实验目的_Load(System::Object^  sender, System::EventArgs^  e) {
	}
			 Thread ^Thread_speek;
			 void speek_control() {
				 Speek(label1->Text);
			 ...
			 void Speek(String ^in) {
				 Thread_speek = gcnew Thread(gcnew ThreadStart(this, &实验10实验目的::speek));
