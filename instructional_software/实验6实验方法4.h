...
namespace instructional_software {
	...
	/// 实验6实验方法4 摘要
	/// </summary>
	public ref class 实验6实验方法4 : public System::Windows::Forms::Form
	{
	public:
		实验6实验方法4(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(实验6实验方法4::typeid));
			...
			this->label1->Text = L"4、时间继电器控制Y-△降压起动控制线路：";
			...
			this->label2->Text = L"关断电源后，按图8－16接线。";
			...
			this->label3->Text = L"（1）起动控制屏，合上Q1，接通380V三相交流电源。";
			...
			this->label4->Text = L"（2）按下SB1，电动机作Y接法起动，观察并记录电机运行情况和交流电流表读数。";
			...
			this->label5->Text = L"（3）经过一定时间延时，电机接△接法正常运行后，观察并记录电机运行情况和交流电流表读数。";
			...
			this->label6->Text = L"（4）按下SB2，电动机M停止运转。";
			...
			this->button1->Click += gcnew System::EventHandler(this, &实验6实验方法4::button1_Click);
			// 
			// 实验6实验方法4
			// 
			...
			this->Name = L"实验6实验方法4";
			this->Text = L"实验6实验方法4";
			this->Load += gcnew System::EventHandler(this, &实验6实验方法4::实验6实验方法4_Load);
...
#pragma endregion
	private: System::Void 实验6实验方法4_Load(System::Object^  sender, System::EventArgs^  e) {
		init();
	}
			 void init() {
			 ...
			 void Speek(String ^in) {
				 Thread_speek = gcnew Thread(gcnew ThreadStart(this, &实验6实验方法4::speek));
