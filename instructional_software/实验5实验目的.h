...
namespace instructional_software {
	...
	/// 实验5实验目的 摘要
	/// </summary>
	public ref class 实验5实验目的 : public System::Windows::Forms::Form
	{
	public:
		实验5实验目的(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"2、通过对此实验的接线，掌握两地控制在机床控制中的应用场合。";
			...
			this->label2->Text = L"l、掌握两地控制的特点，使学生对机床控制中两地控制有感性的认识。";
			...
			this->Name = L"实验5实验目的";
			this->Text = L"实验5实验目的";
			this->Load += gcnew System::EventHandler(this, &实验5实验目的::实验5实验目的_Load);
